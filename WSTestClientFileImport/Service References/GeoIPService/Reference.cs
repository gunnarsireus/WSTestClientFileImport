...
namespace WSTestClientFileImport.GeoIPService {
    ...
    public interface GeoIPServiceSoap {
        ...
        WSTestClientFileImport.GeoIPService.GeoIP GetGeoIP(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        WSTestClientFileImport.GeoIPService.GeoIP GetGeoIPContext();
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface GeoIPServiceSoapChannel : WSTestClientFileImport.GeoIPService.GeoIPServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GeoIPServiceSoapClient : System.ServiceModel.ClientBase<WSTestClientFileImport.GeoIPService.GeoIPServiceSoap>, WSTestClientFileImport.GeoIPService.GeoIPServiceSoap {
        ...
        public WSTestClientFileImport.GeoIPService.GeoIP GetGeoIP(string IPAddress) {
            return base.Channel.GetGeoIP(IPAddress);
        }
        
        public WSTestClientFileImport.GeoIPService.GeoIP GetGeoIPContext() {
